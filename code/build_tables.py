...
politic_path = "C:\\Users\\eLab\\Documents\\Data Science\\AI Lab-Research\\Wikipedia Project\\Data\\politicians_new.json"
scientist_path = "C:\\Users\\eLab\\Documents\\Data Science\\AI Lab-Research\\Wikipedia " \
                 "Project\\Data\\most_influential_scientist_cleaned.json"
female_scientists_path = "C:\\Users\\eLab\\Documents\\Data Science\\AI Lab-Research\\Wikipedia " \
                 "Project\\Data\\notable_women_scientists.json"
athletes_path = "C:\\Users\\eLab\\Documents\\Data Science\\AI Lab-Research\\Wikipedia Project\\Data\\athletsWithSixOlympicAppearances.json"
...
female_politic = [
    ...
    "Victoria Woodhull", "Hillary Clinton", "Kamala Harris", "Margaret Thatcher", 
    "Rosy Senanayake", "Niluka Ekanayake", "Yuriko Koike", "Frances Fitzgerald (politician)", 
    "Pratibha Patil", "Carrie Lam", "Lala Shevket", "Malarndirri McCarthy", 
    "Joanna Lindgren", "Gladys Berejiklian", "Roya Rahmani"
]
...
female_athletes = [
    ...
    'Mönkhbayar Dorjsurengiin', 'Natalia Valeeva', 'Lesley Thompson', 'Nino Salukvadze'
]

# Load dictionaries
with open("C:\\Users\\eLab\\Documents\\Data Science\\Projects\\Project-Linguistic-Bias-In-Wikipedia\\data\\action_verbs.txt", "r") as f_reader:
    action_verbs = set([line.strip() for line in f_reader.readlines()])
        
with open("C:\\Users\\eLab\\Documents\\Data Science\\Projects\\Project-Linguistic-Bias-In-Wikipedia\\data\\state_verbs.txt", "r") as f_reader:
    state_verbs = set([line.strip() for line in f_reader.readlines()])

with open("C:\\Users\\eLab\\Documents\\Data Science\\Projects\\Project-Linguistic-Bias-In-Wikipedia\\data\\strong_verbs.txt", "r") as f_reader:
    strong_verbs = set([line.strip() for line in f_reader.readlines()])

with open("C:\\Users\\eLab\\Documents\\Data Science\\Projects\\Project-Linguistic-Bias-In-Wikipedia\\data\\pos_words_politics.txt", "r") as f_reader:
    pos_words_p = set([line.strip() for line in f_reader.readlines()])

with open("C:\\Users\\eLab\\Documents\\Data Science\\Projects\\Project-Linguistic-Bias-In-Wikipedia\\data\\pos_words_scientits.txt", "r") as f_reader:
    pos_words_s = set([line.strip() for line in f_reader.readlines()])

with open("C:\\Users\\eLab\\Documents\\Data Science\\Projects\\Project-Linguistic-Bias-In-Wikipedia\\data\\neg_words_politics.txt", "r") as f_reader:
    neg_words_p = set([line.strip() for line in f_reader.readlines()])

with open("C:\\Users\\eLab\\Documents\\Data Science\\Projects\\Project-Linguistic-Bias-In-Wikipedia\\data\\neg_words_scientits.txt", "r") as f_reader:
    neg_words_s = set([line.strip() for line in f_reader.readlines()])

with open("C:\\Users\\eLab\\Documents\\Data Science\\Projects\\Project-Linguistic-Bias-In-Wikipedia\\data\\pos_words_athletes.txt", "r") as f_reader:
    pos_words_a = set([line.strip() for line in f_reader.readlines()])

with open("C:\\Users\\eLab\\Documents\\Data Science\\Projects\\Project-Linguistic-Bias-In-Wikipedia\\data\\neg_words_athletes.txt", "r") as f_reader:
...
revisions_df.to_csv("C:\\Users\\eLab\\Documents\\Data Science\\Projects\\Project-Linguistic-Bias-In-Wikipedia\\data\\revisions.txt")
